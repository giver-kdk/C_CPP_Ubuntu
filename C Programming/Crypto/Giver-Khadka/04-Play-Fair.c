...
int doCheck(char table[5][5], char k)
{
	int i, j;
	for (i = 0; i < 5; ++i)
		for (j = 0; j < 5; ++j)
...
l1:
	...
	printf("\nThe cipher has to enter %d filler char.It is either 'x' or 'z'\n",
		   count);
